...
# The V2gMessageId enum from everest-core's types/iso15118.yaml, verbatim.
# everest aborts the consuming module on any id outside it, so an id not in
# this set is published as UnknownMessage instead.
_EVEREST_KNOWN_IDS = {
    "SupportedAppProtocolReq",
    "SupportedAppProtocolRes",
    "SessionSetupReq",
